...
|        |25 bit       | 4bit|1bit<br>是否是偏向锁| 2bit<br>锁标志位
|--------|------------|----------|-|--|
...
![](/img/biased_lock_convert_flow.jpg)
...
![](/img/light_lock_flow.jpg)
![](/img/light_lock_progress.jpg)
