...
##API说明##
<br>实现自定义同步器时，需要使用同步器提供的getState()、setState()和compareAndSetState()方法来操纵状态的变迁。
...
##Mutex 示例##
<br>下面通过一个排它锁的例子来深入理解一下同步器的工作原理，而只有掌握同步器的工作原理才能够更加深入了解其他的并发组件。
排他锁的实现，一次只能一个线程获取到锁。
...
![](http://img2.tbcdn.cn/L1/461/1/t_9683_1379328542_928191748.png)
...
![](http://img2.tbcdn.cn/L1/461/1/t_9683_1379328891_568034081.png)
...
![](http://img1.tbcdn.cn/L1/461/1/t_9683_1379328959_1702388031.png)
